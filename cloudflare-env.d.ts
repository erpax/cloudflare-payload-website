/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 15bf0c85474336274304a54b7a4a24c1)
...
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		BLOB_STORAGE_ENABLED: string;
		BLOB_STORE_ID: string;
		NEXT_PUBLIC_CLOUD_CMS_URL: string;
		NEXT_PUBLIC_SITE_URL: string;
		NEXT_PRIVATE_DRAFT_SECRET: string;
		NEXT_PRIVATE_REVALIDATION_KEY: string;
		GITHUB_ACCESS_TOKEN: string;
		NEXT_PUBLIC_ALGOLIA_DOCSEARCH_KEY: string;
		...
		DISCORD_SCRAPE_CHANNEL_ID: string;
		NEXT_PUBLIC_ALGOLIA_CH_ID: string;
		NEXT_PUBLIC_ALGOLIA_PUBLIC_KEY: string;
		NEXT_PRIVATE_ALGOLIA_API_KEY: string;
		NEXT_PUBLIC_ALGOLIA_CH_INDEX_NAME: string;
		SITEMAP_URL: string;
		NEXT_PRIVATE_CRON_KEY: string;
		NEXT_PUBLIC_NEWSLETTER_FORM_ID: string;
		NEXT_PUBLIC_SKIP_BUILD_DOCS: string;
		NEXT_PUBLIC_SKIP_BUILD_HELPS: string;
		DOCS_DIR_V2: string;
		DOCS_DIR_V3: string;
		NEXT_PUBLIC_ENABLE_BETA_DOCS: string;
		NEXT_PUBLIC_ENABLE_LEGACY_DOCS: string;
		COMMIT_DOCS_API_URL: string;
		COMMIT_DOCS_API_KEY: string;
		NEXT_PUBLIC_OMIT_CLOUD_ERRORS: string;
		VERCEL_REDEPLOY_URL: string;
		PAYLOAD_RELEASE_SECRET: string;
		NEXT_PUBLIC_RECAPTCHA_SITE_KEY: string;
		NEXT_PRIVATE_RECAPTCHA_SECRET_KEY: string;
	}
	...
	interface Env {
		ASSETS: Fetcher;
		PAYLOAD_PUBLIC_APP_URL?: "https://payloadcms.com" | "http://localhost:3000";
		DATABASE_URI: string;
		PAYLOAD_SECRET: string;
		BLOB_READ_WRITE_TOKEN: string;
		BLOB_STORAGE_ENABLED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_PUBLIC_APP_URL" | "DATABASE_URI" | "PAYLOAD_SECRET" | "BLOB_READ_WRITE_TOKEN" | "BLOB_STORAGE_ENABLED" | "BLOB_STORE_ID" | "NEXT_PUBLIC_CLOUD_CMS_URL" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PRIVATE_DRAFT_SECRET" | "NEXT_PRIVATE_REVALIDATION_KEY" | "GITHUB_ACCESS_TOKEN" | "NEXT_PUBLIC_ALGOLIA_DOCSEARCH_KEY" | "NEXT_PUBLIC_GA_MEASUREMENT_ID" | "NEXT_PUBLIC_FACEBOOK_PIXEL_ID" | "NEXT_PUBLIC_IS_LIVE" | "NEXT_PUBLIC_GITHUB_REDIRECT_URI" | "NEXT_PUBLIC_GITHUB_CLIENT_ID" | "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" | "STRIPE_SECRET_KEY" | "DISCORD_TOKEN" | "DISCORD_SCRAPE_CHANNEL_ID" | "NEXT_PUBLIC_ALGOLIA_CH_ID" | "NEXT_PUBLIC_ALGOLIA_PUBLIC_KEY" | "NEXT_PRIVATE_ALGOLIA_API_KEY" | "NEXT_PUBLIC_ALGOLIA_CH_INDEX_NAME" | "SITEMAP_URL" | "NEXT_PRIVATE_CRON_KEY" | "NEXT_PUBLIC_NEWSLETTER_FORM_ID" | "NEXT_PUBLIC_SKIP_BUILD_DOCS" | "NEXT_PUBLIC_SKIP_BUILD_HELPS" | "DOCS_DIR_V2" | "DOCS_DIR_V3" | "NEXT_PUBLIC_ENABLE_BETA_DOCS" | "NEXT_PUBLIC_ENABLE_LEGACY_DOCS" | "COMMIT_DOCS_API_URL" | "COMMIT_DOCS_API_KEY" | "NEXT_PUBLIC_OMIT_CLOUD_ERRORS" | "VERCEL_REDEPLOY_URL" | "PAYLOAD_RELEASE_SECRET" | "NEXT_PUBLIC_RECAPTCHA_SITE_KEY" | "NEXT_PRIVATE_RECAPTCHA_SECRET_KEY" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "NEXT_PUBLIC_CF_WEB_ANALYTICS_TOKEN" | "MAIL_FROM_ADDRESS" | "MAIL_FROM_NAME">> {}
}
